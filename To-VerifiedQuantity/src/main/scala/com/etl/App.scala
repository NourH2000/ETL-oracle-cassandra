...
object App {
  ...
  def main(args : Array[String]) {
    ...
    val query = "(select id , gender , ts , affection , age , date_paiment , codeps , fk , num_enr , quantite_med  , region , no_assure  , quantite_rejetee from fraud  where quantite_rejetee > 0 ) s"
