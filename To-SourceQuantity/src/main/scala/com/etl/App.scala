...
object App {
  ...
  def main(args : Array[String]) {
    ...
    rows.saveToCassandra("frauddetection", "quantity_source", SomeColumns("id" , "affection" , "age", "date_paiment", "codeps", "fk", "num_enr", "quantite_med" , "region", "no_assure" , "gender", "ts"));
